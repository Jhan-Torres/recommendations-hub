...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="md:w-1/2 bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center p-8 relative"
      >
      ...
      <section class="md:w-1/2 flex flex-col max-h-[50vh] md:max-h-[90vh]">
        <!-- Header -->
        <header
