<template>
  ...
  >
    ...
    >
      ...
      <div class="md:w-1/2 bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center p-8 relative">
        ...
        <div class="text-center text-white">
          ...
          <h2 class="text-2xl sm:text-3xl font-bold mb-2">{{ recommendation.name }}</h2>
          ...
          <div class="flex items-center justify-center space-x-1 mb-4">
            ...
            />
            <span class="ml-2 text-lg font-semibold">{{ recommendation.rating }}/5</span>
          </div>
      ...
      <div class="md:w-1/2 flex flex-col max-h-[50vh] md:max-h-[90vh]">
        ...
        <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between flex-shrink-0">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <p class="font-semibold text-gray-900 dark:text-white text-sm">{{ t('yourRecommendation') }}</p>
              <p class="text-xs text-gray-500 dark:text-gray-400">{{ formatDate(recommendation.createdAt) }}</p>
            </div>
          </div>
          ...
          <div class="flex space-x-3">
            ...
            <div class="flex-1">
              <div class="flex items-center space-x-2 mb-1">
                <span class="font-semibold text-sm text-gray-900 dark:text-white">{{ t('you') }}</span>
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ formatDate(recommendation.createdAt) }}</span>
              </div>
              <p class="text-sm text-gray-700 dark:text-gray-300">
                {{ t('recommendationDescription', { name: recommendation.name, genre: getGenreLabel(recommendation.genre), rating: recommendation.rating }) }}
              </p>
            </div>
          </div>
